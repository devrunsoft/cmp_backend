...
{
    public class RegisterCompanyHandler : IRequestHandler<RegisterCompanyCommand, CompanyResponse>
    {
        ...
        public async Task<CompanyResponse> Handle(RegisterCompanyCommand request, CancellationToken cancellationToken)
        {

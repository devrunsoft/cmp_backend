...
{
    public class AdminProviderSubmitRequestHandler : IRequestHandler<AdminProviderSubmitRequestCommand, CommandResponse<RequestResponse>>
    {
        ...
        public AdminProviderSubmitRequestHandler(IinvoiceRepository invoiceRepository, IProductPriceRepository productPriceRepository,
        ...
        public async Task<CommandResponse<RequestResponse>> Handle(AdminProviderSubmitRequestCommand requests, CancellationToken cancellationToken)
        {
            var invoice = (await _invoiceRepository.GetAsync(p => p.Id == requests.RequestId,

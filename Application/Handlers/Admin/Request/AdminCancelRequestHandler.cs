...
{
    public class AdminCancelRequestHandler : IRequestHandler<AdminCancelRequestCommand, CommandResponse<RequestEntity>>
    {
        ...
        public AdminCancelRequestHandler(IRequestRepository invoiceRepository, IBaseServiceAppointmentRepository _baseServiceAppointmentRepository)
        {
            _invoiceRepository = invoiceRepository;
            this._baseServiceAppointmentRepository = _baseServiceAppointmentRepository;
        }

        public async Task<CommandResponse<RequestEntity>> Handle(AdminCancelRequestCommand request, CancellationToken cancellationToken)
        {

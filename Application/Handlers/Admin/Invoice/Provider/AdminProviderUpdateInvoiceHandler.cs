...
{
    public class AdminProviderUpdateInvoiceHandler : IRequestHandler<AdminProviderUpdateInvoiceCommand, CommandResponse<InvoiceResponse>>
    {
        ...
        public async Task<CommandResponse<InvoiceResponse>> Handle(AdminProviderUpdateInvoiceCommand requests, CancellationToken cancellationToken)
        {

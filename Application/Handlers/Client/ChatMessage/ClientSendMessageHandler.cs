...
namespace CMPNatural.Application.Handlers.Admin
{
    public class ClientSendMessageHandler : IRequestHandler<ClientSendMessageCommand, CommandResponse<ChatMessage>>
    {
        ...
        public ClientSendMessageHandler(IChatMessageRepository _repository, IChatSessionRepository _chatSessionRepository, IChatService _chatService, IMediator _mediator)
        {

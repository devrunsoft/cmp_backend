...
namespace CMPNatural.Application.Handlers
{
    ...
    public class CreateRequestHandler : IRequestHandler<CreateRequestCommand, CommandResponse<RequestEntity>>
    {
        ...
        public CreateRequestHandler(IRequestRepository invoiceRepository, IProductPriceRepository productPriceRepository, IInvoiceSourceRepository invoiceSourceRepository, ILocationCompanyRepository locationCompanyRepository)
        {
        ...
        public async Task<CommandResponse<RequestEntity>> Handle(CreateRequestCommand requests, CancellationToken cancellationToken)
        {
            ...
            var entity = new RequestEntity()
            {
                ...
                CreatedAt = DateTime.Now,
                BillingInformationId = requests.BillingInformationId,
                Type = InvoiceType.Draft_Invoice,
            };
            ...
            return new Success<RequestEntity>() { Data = result };

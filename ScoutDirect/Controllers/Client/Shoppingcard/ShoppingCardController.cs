...
namespace CMPNatural.Api.Controllers.shoppingcard
{
    ...
    public class ShoppingCardController : BaseClientApiController
    {
        ...
        public async Task<ActionResult> Post([FromBody] ServiceAppointmentInput request)
        {
            ...
            if (result.IsSucces())
            {
                sendNote(MessageNoteType.AddToShoppingCardByClient , result.Data.OperationalAddressId, result.Data, result.Data.NoteTitle);
            }
        ...
        public async Task<ActionResult> Delete([FromRoute] long Id)
        {
            ...
            if (result.IsSucces())
            {
                sendNote(MessageNoteType.DeleteFromShoppingCardByClient, result.Data.OperationalAddressId, result.Data, result.Data.NoteTitle);
            }

...
namespace CMPNatural.Api.Controllers
{
    ...
    public class RegisterCompanyController : BaseClientApiController
    {
        ...
        public RegisterCompanyController(IMediator mediator, IConfiguration configuration, IWebHostEnvironment env, IOptions<ExpiresModel> _expiresModel, HighLevelSettings _highLevelSetting, AppSetting appSetting) : base(mediator)
        {
            _mediator = mediator;
...
<body>
    <div class=""container"">
        ...
        <a href=""{_appSetting.clientHost}/logout"" class=""button"">Back To Application</a>
    </div>
</body>
</html>";
            }

...
namespace CMPNatural.Api.Controllers.Admin.Invoice
{
    ...
    public class AdminInvoiceController : BaseAdminApiController
    {
        ...
        public async Task<ActionResult> Pay([FromRoute] long InvoiceId)
        {
            ...
            sendNote(MessageNoteType.PayedByAdmin, result.Data.CompanyId, result.Data.OperationalAddressId, result.Data, result.Data.InvoiceNumber ?? "");
            return Ok(result);
        }
        ...
        public async Task<ActionResult> Delete([FromRoute] long InvoiceId)
        {
            ...
            if (result.IsSucces())
            {
                sendNote(MessageNoteType.RequestCanceledByClient, result.Data.CompanyId , result.Data.OperationalAddressId, result.Data, result.Data.NoteTitle ?? "");
            }
            return Ok(result);
        }
